#Hi I am Zaid Ahmad completed MCA from JAMIA MILLIA ISLAMIA
#THIS CODE IS WRITTEN TO DOWNLOAD ALL ATTACHMENTS AND PLAIN TEXT(BODY) FROM GMAIL OR OTHER EMAIL CLIENTS AND
#SAVE THEM INTO THEIR CORRESPONDING LOCAL FOLDERS(FOLDER NAME WILL GET CREATED BY TO SENDER'S EMAIL AUTOMATICALLY)
